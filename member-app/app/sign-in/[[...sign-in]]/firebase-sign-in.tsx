  ...
  return (
    <div className="auth-form">
      ...
      <form className="auth-form" onSubmit={signInWithEmail}>
        <label className="auth-label" htmlFor="member-email">Email address
          <input className="auth-input" id="member-email" autoComplete="email" type="email" value={email} onChange={(event) => setEmail(event.target.value)} required disabled={isBusy} />
        </label>
        <label className="auth-label" htmlFor="member-password">Password
          <input className="auth-input" id="member-password" autoComplete="current-password" type="password" value={password} onChange={(event) => setPassword(event.target.value)} required disabled={isBusy} />
        </label>
